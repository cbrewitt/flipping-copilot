...
public class FlipV2 {
    ...
    public static Comparator<FlipV2> CLOSED_TIME_ASC_CMP = Comparator.comparingInt(FlipV2::getClosedTime).thenComparing(FlipV2::getId);
    public static Comparator<FlipV2> CLOSED_TIME_DESC_CMP = Comparator.comparingInt(FlipV2::getClosedTime).reversed().thenComparing(FlipV2::getId);
    ...
    public static FlipV2 comparisonFlip(int timestamp) {
        FlipV2 f = new FlipV2();
        f.setId(new UUID(0L, 0L));
        f.setClosedTime(timestamp);
        return f;
    }
