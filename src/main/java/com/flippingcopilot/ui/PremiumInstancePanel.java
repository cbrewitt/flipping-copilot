...
public class PremiumInstancePanel extends JPanel {
    ...
    public PremiumInstancePanel(FlippingCopilotConfig config, ApiRequestHandler apiRequestHandler) {
        this.config = config;
    ...
    private JPanel createLoadingPanel() {
        ...
        gbc.gridy = 1;
        JLabel loadingLabel = new JLabel("Loading premium instance data");
    ...
    public void showManagementView(PremiumInstanceStatus status) {
        ...
        JLabel countLabel = new JLabel("You have " + status.getPremiumInstancesCount() + " premium instances");
        ...
        for (int i = 0; i < status.getPremiumInstancesCount(); i++) {
            ...
            JLabel instanceLabel = new JLabel("Instance " + (i + 1) + ":");
            instanceLabel.setForeground(Color.WHITE);
            instanceLabel.setPreferredSize(new Dimension(80, 25));
            ...
            if (i < status.getCurrentlyAssignedDisplayNames().size()) {
                String currentAssignment = status.getCurrentlyAssignedDisplayNames().get(i);
        ...
        JLabel changesLabel = new JLabel("Changes remaining: " + status.getChangesRemaining());
        changesLabel.setForeground(config.lossAmountColor());
        changesLabel.setToolTipText("Remaining updates. This limit recharges by 1 every 12 hours up to a max of 10.");
