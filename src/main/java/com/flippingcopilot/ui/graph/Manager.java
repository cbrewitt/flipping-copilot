...
public class Manager {
     ...
     */
    public static void showPriceGraph(Component parent, Data data, PriceGraphConfigManager configManager) {
        try {
    ...
    private static void showGraphView(PriceGraphConfigManager configManager) {
        ...
        try {
            ...
            JLabel settingsButton = ConfigPanel.buildButton(recoloredIcon, "Settings", () -> {
                ...
                showSettingsView(configManager);
            });
        ...
        StatsPanel statsPanel = new StatsPanel(dm, configManager);
     ...
     */
    private static void showSettingsView(PriceGraphConfigManager configManager) {
        if (mainPanel == null) {
