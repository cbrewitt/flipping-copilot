...
public class Manager {
     ...
     */
    public static void showPriceGraph(Component parent, Data data) {
        try {
    ...
    private static void showGraphView() {
        ...
        GraphPanel graphPanel = new GraphPanel(currentData);

        // Create settings button with gear icon
        JPanel statsHeaderPanel = new JPanel(new BorderLayout());
        statsHeaderPanel.setBackground(ColorScheme.DARKER_GRAY_COLOR);
        ...
        try {
            ...
            statsHeaderPanel.setBackground(Config.BACKGROUND_COLOR);
        } catch (Exception e) {
        ...
        StatsPanel statsPanel = new StatsPanel(currentData);
    ...
    private static void showSettingsView() {
        ...
        try {
            ...
            topPanel.setBackground(Config.BACKGROUND_COLOR);
