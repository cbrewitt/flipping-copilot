...
public class Config {
    ...
    public Color lowColor = new Color(220, 50, 50);
    public Color highColor = new Color(50, 50, 220);
    public Color lowShadeColor = new Color(220, 50, 50, 40);
    public Color highShadeColor = new Color(50, 50, 220, 40);

    public Color backgroundColor = ColorScheme.DARKER_GRAY_COLOR.brighter();
    public Color plotAreaColor = ColorScheme.LIGHT_GRAY_COLOR.brighter();
