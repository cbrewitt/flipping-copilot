...
public class StatsPanelV2 extends JPanel {
    ...
    public StatsPanelV2(LoginResponseManager loginResponseManager,
                        ...
                        ClientThread clientThread, FlipsDialogController flipsDialogController) {
        ...
        displayNameDropdown = new DisplayNameDropdown(
                ...
                flipManager::setIntervalDisplayName
        );
        ...
        intervalRsAccountDropdownWrapper.add(displayNameDropdown, BorderLayout.SOUTH);
    ...
    private void setupFlipsDialogButton() {
        ...
        flipsDialogButton.addActionListener(e -> {
            // TODO: Implement flips dialog logic
            flipsDialogController.showFlipsDialog();
            log.info("Flips dialog button clicked");
        });
    }
    ...
    public void refresh(boolean flipsMaybeChanged, boolean validLoginState) {
        ...
        if (!validLoginState) {
            ...
            displayNameDropdown.setVisible(false);
            return;
        }

        displayNameDropdown.setSelectedDisplayName(flipManager.getIntervalDisplayName());
        displayNameDropdown.setVisible(true);
