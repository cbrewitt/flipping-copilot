...
public interface CopilotConfig extends Config {
    public enum PriceGraphWebsite {
        ...
        PriceGraphWebsite(String name) { this.name = name; }
    ...
    default boolean suggestionHighlights() { return true; }
    ...
    default boolean lowDataMode() { return false; }
    @ConfigItem(
    ...
    default boolean slotActionSwap() { return true; }
    ...
    default boolean disableLeftClickConfirm() { return false; }
    ...
    default Keybind quickSetKeybind() { return new Keybind(KeyEvent.VK_E, 0); }
    ...
    default Keybind skipSuggestionKeybind() { return Keybind.NOT_SET; }
    ...
    default Keybind openGraphKeybind() { return Keybind.NOT_SET; }

    @ConfigSection(name = "Appearance", description = "Configure visual appearance and colors", position = 2 )
    ...
    default boolean priceGraphMenuOptionEnabled() { return true; }
    ...
    default PriceGraphWebsite priceGraphWebsite() { return PriceGraphWebsite.FLIPPING_COPILOT; }
    ...
    default Color profitAmountColor() { return ColorScheme.GRAND_EXCHANGE_PRICE; }
    ...
    default Color lossAmountColor() { return UIUtilities.OUTDATED_COLOR; }
    ...
    default boolean portfolioBankTag() { return true; }
    ...
    default boolean portfolioTooltips() { return true; }
    ...
    default boolean portfolioIcons() { return true; }
    ...
    default boolean slotPriceColorEnabled() { return false; }
    ...
    default Color slotPriceProfitableColor() { return new Color(0xAFDCFF); }
    ...
    default Color slotPriceUnprofitableColor() { return new Color(0xFF5E5E); }
    ...
    default boolean dumpAlertSound() { return true; }
    ...
    default boolean enableChatNotifications() { return true; }
    ...
    default boolean enableTrayNotifications() { return true; }
    ...
    default Color chatTextColor() { return new Color(0x0040FF); }
