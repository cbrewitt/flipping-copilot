...
public enum SuggestionType {
    ...
    SuggestionType(int protoInt) { this.protoInt = protoInt; }

    public int protoInt() { return protoInt; }

    public String apiValue() { return name().toLowerCase(Locale.ROOT); }

    @Override
    public String toString() { return apiValue(); }

    public static SuggestionType fromProtoInt(int protoInt) {
        for (SuggestionType value : values()) {
            if (value.protoInt == protoInt) { return value; }
        }
        return null;
    }
