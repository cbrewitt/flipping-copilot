...
public final class PortfolioId {
    ...
    public static final int COFLIP_PORTFOLIO = 0, PERSONAL_PORTFOLIO = 1;
    ...
    public static final int DISAPPEARED_COFLIP = -2, DISAPPEARED_GHOST = -3, DISAPPEARED_PERSONAL = -4;
    ...
    public static boolean isMissed(int portfolioId) { return portfolioId == GHOST || isDisappeared(portfolioId); }
}
