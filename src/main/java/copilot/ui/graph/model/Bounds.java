...
public class Bounds {
    ...
    public long yMin, yMax;
    public long y2Min, y2Max;
    ...
    public long y2Delta() { return y2Max - y2Min; }

    public long yDelta() { return yMax - yMin; }

    public int xDelta() { return xMax - xMin; }

    public int xMid() { return xMin + (xMax - xMin)/2; }

    public Bounds copy() { return new Bounds(xMin, xMax, yMin, yMax, y2Min, y2Max); }
