...
@NoArgsConstructor
public class Config {
    public static int LABEL_PADDING = 20, TICK_SIZE = 5, BASE_POINT_SIZE = 4;

    public static int GRAPH_BUTTON_SIZE = 24, GRAPH_BUTTON_MARGIN = 5;

    public static int HOVER_RADIUS = 8; // Distance in pixels to detect hovering

    public static final Stroke THIN_STROKE = new BasicStroke(0.5f), NORMAL_STROKE = new BasicStroke(1f);
    ...
    public boolean connectPoints = true, showSuggestedPriceLines = true;
    public Color lowColor = new Color(0, 153, 255), highColor = new Color(255, 102, 0);
    public Color lowShadeColor = new Color(0, 153, 255, 60), highShadeColor = new Color(255, 102, 0, 60);

    public Color backgroundColor = ColorScheme.DARKER_GRAY_COLOR.brighter();
    public Color plotAreaColor = new Color(51, 51, 51), textColor = new Color(225, 225, 225);
    public Color axisColor = new Color(150, 150, 150), gridColor = new Color(85, 85, 85, 90);
}
