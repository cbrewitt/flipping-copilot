...
public class GpDropOverlay extends Overlay {
    ...
    public GpDropOverlay(OverlayManager overlayManager, Client client, long profit, int slot) {
        this.overlayManager = overlayManager; startTime = System.currentTimeMillis();
        ...
        if (profit < 0) { textComponent.setColor(Color.RED); } else {
    ...
    public Dimension render(Graphics2D graphics) {
        ...
        var currentPosition = new Point(startPosition.x, startPosition.y - yOffset);
