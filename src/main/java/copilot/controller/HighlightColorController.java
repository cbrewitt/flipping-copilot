...
public class HighlightColorController {
    ...
    private static final int BASE_ALPHA = 79, MIN_ALPHA = 31, DUMP_ALPHA_MAX = 127;
    private static final double DUMP_ALPHA_FREQUENCY_HZ = 2.0;

    public Color getRedColor() { return getRedColor(false); }
    ...
    public Color getBlueColor() { return getBlueColor(false); }
    ...
    public Color getAmberColor() { return getAmberColor(false); }
    ...
    private int calculateAlpha(boolean isDumpAlert) {
        if (!isDumpAlert) { return BASE_ALPHA; }
