...
public class PatchNotesController {
    ...
    public void maybeShowOnStartup(Component parent, boolean hadExistingInstallation) {
        ...
        if (!shouldShow || GraphicsEnvironment.isHeadless()) { return; }
    ...
    private Path patchNotesVersionPath() { return Persistance.COPILOT_DIR.toPath().resolve(PATCH_NOTES_VERSION_FILE); }
}
